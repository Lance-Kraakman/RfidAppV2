...
import com.example.rfidappv2.provisioning.listeners.ProvisionListener;
import com.example.rfidappv2.provisioning.listeners.ResponseListener;
import com.example.rfidappv2.provisioning.listeners.WiFiScanListener;
import com.example.rfidappv2.provisioning.security.Security;
import com.example.rfidappv2.provisioning.security.Security0;
import com.example.rfidappv2.provisioning.security.Security1;
import com.example.rfidappv2.provisioning.transport.BLETransport;
import com.example.rfidappv2.provisioning.transport.SoftAPTransport;
import com.example.rfidappv2.provisioning.transport.Transport;
import com.example.rfidappv2.provisioning.utils.MessengeHelper;
...
public class ESPDevice {
    ...
    private com.example.rfidappv2.provisioning.Session session;
    ...
    private com.example.rfidappv2.provisioning.ESPConstants.TransportType transportType;
    private com.example.rfidappv2.provisioning.ESPConstants.SecurityType securityType;

    private String proofOfPossession = "";
    private String versionInfo;
    private int totalCount;
    private int startIndex;
    private ArrayList<com.example.rfidappv2.provisioning.WiFiAccessPoint> wifiApList;
    private ArrayList<String> deviceCapabilities = new ArrayList<>();
    private BluetoothDevice bluetoothDevice;
    private com.example.rfidappv2.provisioning.WiFiAccessPoint wifiDevice;
    ...
    public ESPDevice(Context context, com.example.rfidappv2.provisioning.ESPConstants.TransportType transportType, com.example.rfidappv2.provisioning.ESPConstants.SecurityType securityType) {
    ...
    public void connectBLEDevice(BluetoothDevice bluetoothDevice, String primaryServiceUuid) {
        ...
        if (transport instanceof BLETransport) {
            ...
            EventBus.getDefault().post(new com.example.rfidappv2.provisioning.DeviceConnectionEvent(com.example.rfidappv2.provisioning.ESPConstants.EVENT_DEVICE_CONNECTION_FAILED));
        }
    }
     ...
     */
    public com.example.rfidappv2.provisioning.ESPConstants.TransportType getTransportType() {
     ...
     */
    public com.example.rfidappv2.provisioning.ESPConstants.SecurityType getSecurityType() {
        return securityType;
    }
     ...
     */
    public com.example.rfidappv2.provisioning.WiFiAccessPoint getWifiDevice() {
        return wifiDevice;
    }

    public void setWifiDevice(com.example.rfidappv2.provisioning.WiFiAccessPoint wifiDevice) {
    ...
    private void initSession(final ResponseListener listener) {
        ...
        if (securityType.equals(com.example.rfidappv2.provisioning.ESPConstants.SecurityType.SECURITY_0)) {
            security = new Security0();
        } else {
            security = new Security1(proofOfPossession);
        }

        session = new com.example.rfidappv2.provisioning.Session(transport, security);

        session.init(null, new com.example.rfidappv2.provisioning.Session.SessionListener() {
    ...
    private void startNetworkScan() {
        ...
        session.sendDataToDevice(com.example.rfidappv2.provisioning.ESPConstants.HANDLER_PROV_SCAN, scanCommand, new ResponseListener() {
            ...
            public void onSuccess(byte[] returnData) {
                ...
                session.sendDataToDevice(com.example.rfidappv2.provisioning.ESPConstants.HANDLER_PROV_SCAN, getScanStatusCmd, new ResponseListener() {
    ...
    private void getWiFiScanList(int start, int count) {
        ...
        session.sendDataToDevice(com.example.rfidappv2.provisioning.ESPConstants.HANDLER_PROV_SCAN, data, new ResponseListener() {
    ...
    private void sendWiFiConfig(final String ssid, final String passphrase, final ProvisionListener provisionListener) {
        ...
        session.sendDataToDevice(com.example.rfidappv2.provisioning.ESPConstants.HANDLER_PROV_CONFIG, scanCommand, new ResponseListener() {
    ...
    private void pollForWifiConnectionStatus() {
        ...
        session.sendDataToDevice(com.example.rfidappv2.provisioning.ESPConstants.HANDLER_PROV_CONFIG, message, new ResponseListener() {
            ...
            public void onSuccess(byte[] returnData) {
                ...
                if (wifiStationState == WifiConstants.WifiStationState.Connected) {
                    ...
                    if (provisionListener != null) {
                        provisionListener.provisioningFailedFromDevice(com.example.rfidappv2.provisioning.ESPConstants.ProvisionFailureReason.DEVICE_DISCONNECTED);
                    }
                    session = null;
                    disableOnlyWifiNetwork();
                    ...
                    if (failedReason == WifiConstants.WifiConnectFailedReason.AuthError) {
                        ...
                        provisionListener.provisioningFailedFromDevice(com.example.rfidappv2.provisioning.ESPConstants.ProvisionFailureReason.AUTH_FAILED);

                    } else if (failedReason == WifiConstants.WifiConnectFailedReason.NetworkNotFound) {

                        provisionListener.provisioningFailedFromDevice(com.example.rfidappv2.provisioning.ESPConstants.ProvisionFailureReason.NETWORK_NOT_FOUND);

                    } else {
                        provisionListener.provisioningFailedFromDevice(com.example.rfidappv2.provisioning.ESPConstants.ProvisionFailureReason.UNKNOWN);
                    }
                    session = null;
                    disableOnlyWifiNetwork();
                }
        ...
        try {
            ...
            for (int i = 0; i < response.getEntriesCount(); i++) {
                ...
                if (!isAvailable) {
                    ...
                    com.example.rfidappv2.provisioning.WiFiAccessPoint wifiAp = new com.example.rfidappv2.provisioning.WiFiAccessPoint();
    ...
    private Runnable getCapabilitiesTask = new Runnable() {
        ...
        public void run() {
            ...
            transport.sendConfigData(com.example.rfidappv2.provisioning.ESPConstants.HANDLER_PROTO_VER, tempData.getBytes(), new ResponseListener() {
                ...
                public void onSuccess(byte[] returnData) {
                    ...
                    EventBus.getDefault().post(new com.example.rfidappv2.provisioning.DeviceConnectionEvent(com.example.rfidappv2.provisioning.ESPConstants.EVENT_DEVICE_CONNECTED));
                }

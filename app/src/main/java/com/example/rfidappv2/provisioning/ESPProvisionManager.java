...
import com.example.rfidappv2.provisioning.device_scanner.BleScanner;
import com.example.rfidappv2.provisioning.device_scanner.WiFiScanner;
import com.example.rfidappv2.provisioning.listeners.BleScanListener;
import com.example.rfidappv2.provisioning.listeners.QRCodeScanListener;
...
public class ESPProvisionManager {
     ...
     */
    public ESPDevice createESPDevice(com.example.rfidappv2.provisioning.ESPConstants.TransportType transportType, com.example.rfidappv2.provisioning.ESPConstants.SecurityType securityType) {
    ...
    public void scanQRCode(final Activity activityContext, final com.example.rfidappv2.provisioning.CameraSourcePreview cameraSourcePreview, final QRCodeScanListener qrCodeScanListener) {
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                if (barcodes.size() != 0 && !isScanned) {
                    ...
                    try {
                        ...
                        com.example.rfidappv2.provisioning.ESPConstants.TransportType transportType = null;
                        com.example.rfidappv2.provisioning.ESPConstants.SecurityType securityType = null;

                        if (!TextUtils.isEmpty(transport)) {

                            if (transport.equalsIgnoreCase("softap")) {

                                transportType = com.example.rfidappv2.provisioning.ESPConstants.TransportType.TRANSPORT_SOFTAP;

                            } else if (transport.equalsIgnoreCase("ble")) {

                                transportType = com.example.rfidappv2.provisioning.ESPConstants.TransportType.TRANSPORT_BLE;
                        ...
                        if (security == 0) {
                            securityType = com.example.rfidappv2.provisioning.ESPConstants.SecurityType.SECURITY_0;
                        } else {
                            securityType = com.example.rfidappv2.provisioning.ESPConstants.SecurityType.SECURITY_1;
                        }
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && transportType.equals(com.example.rfidappv2.provisioning.ESPConstants.TransportType.TRANSPORT_SOFTAP)) {

                            com.example.rfidappv2.provisioning.WiFiAccessPoint wiFiDevice = new com.example.rfidappv2.provisioning.WiFiAccessPoint();
    ...
    class SearchDeviceTask implements Runnable {
        ...
        public void run() {
            ...
            if (device.getTransportType().equals(com.example.rfidappv2.provisioning.ESPConstants.TransportType.TRANSPORT_BLE)) {
                ...
                searchWiFiEspDevices(new WiFiScanListener() {
                    ...
                    @Override
                    public void onWifiListReceived(ArrayList<com.example.rfidappv2.provisioning.WiFiAccessPoint> scanResults) {
                        ...
                        for (int i = 0; i < scanResults.size(); i++) {
                            ...
                            if (scanResults.get(i).getWifiName().equals(device.getDeviceName())) {
                                // Device found
                                isDeviceFound = true;
                                com.example.rfidappv2.provisioning.WiFiAccessPoint wiFiDevice = scanResults.get(i);
                                wiFiDevice.setPassword(password);
